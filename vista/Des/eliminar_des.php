    ...
    <div class="container col-6 bg-">
        <div class="col-12"></div>
            <div class="formulario" style="margin-top: 100px;"><center>
                <h2>Consultar despacho</h2></center>
                <form action="eliminar2_des.php" style="margin-top: 50px;" method="POST">
                    <div class="form-group row">
                        <label class="form-check-label" for="id_despacho">Id despacho:</label>
                    </div>
                    <div class="form-group row">
